...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "See what your transaction will actually do — before you sign it.",
      },
      ...
      <QueryClientProvider client={queryClient}>
        ...
        <Toaster
          ...
          toastOptions={{
            classNames: {
              toast:
                "vantage-glass-heavy !text-white/90 !rounded-xl !shadow-[0_20px_60px_-20px_rgba(0,0,0,0.7)]",
