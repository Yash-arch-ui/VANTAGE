...
/**
 * MagicRings — @react-bits/MagicRings-TS-TW.
 * A transparent WebGL shader that draws expanding, fading rings. Because the
 * renderer is alpha-blended it can sit on top of a card without hiding the
 * content beneath it.
 */
const vertexShader = `
void main() {
